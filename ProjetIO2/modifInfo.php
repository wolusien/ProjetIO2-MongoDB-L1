...
<html lang="fr">
    ...
    <body>
		...
		<h2><strong>Si vous ne voulez pas modifier certaines informations, retapez ces informations dans le formulaire</strong></h2>
		<form action='saveModifInfo.php' method='post'>
